...
| getsymbol(str, 5) | возвращает подстроку под индексом 5 в изначальной строке |
| tostring(integer), tostring(float) | преобразует integer или float в string и возвращает string |
