...
public class LexerTest
{
    ...
    public static TheoryData<string, List<Token>> AllTestData()
    {
        return new TheoryData<string, List<Token>>
        {
            ...
            {
                "var pi : number = 3.14; var name : string = \"Vladimir\"; var l : bool = false;", [
                    new Token(TokenType.Var),
                    new Token(TokenType.Identifier, new TokenValue("pi")),
                    new Token(TokenType.Colon),
                    new Token(TokenType.NumberType),
                    ...
                    new Token(TokenType.Semicolon),
                    new Token(TokenType.Var),
                    new Token(TokenType.Identifier, new TokenValue("l")),
                    new Token(TokenType.Colon),
            ...
            {
                "while (true) do begin continue; end", [
            ...
            {
                "function add(a : number, b : number) : number begin return a + b; end", [
